...
const LETTERS = {
  block: 'plate', blockRound: 'plate', square: 'squareSans', chamfer: 'squareSans', titans: 'plate', chiefs: 'plate', cowboys: 'slab', vikings: 'squareSans', chargers: 'italic', angular: 'squareSans',
