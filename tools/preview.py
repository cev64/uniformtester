...
MATCOL = {'jersey': (0.02, 0.09, 0.05), 'sleeve': (0.02, 0.09, 0.05), 'pants': (0.9, 0.6, 0.02), 'socks': (0.02, 0.09, 0.05),
          ...
          'shell': (0.95, 0.62, 0.02), 'liner': (0.05, 0.05, 0.05), 'trim': (0.02, 0.02, 0.02), 'mask': (0.02, 0.12, 0.07), 'clip': (0.3, 0.3, 0.3), 'collar': (0.9, 0.6, 0.02), 'cup': (0.9, 0.9, 0.9), 'strap': (0.9, 0.9, 0.9), 'pad': (0.08, 0.08, 0.09)}
